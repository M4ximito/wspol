...
mutex licznikMutex;//this is need to commented too oke???
...
public:
    ...
    void operator()()
    {
        lock_guard<mutex> blokada(licznikMutex);// editowana versja programu in 1 version it need to be commented okey??????????
